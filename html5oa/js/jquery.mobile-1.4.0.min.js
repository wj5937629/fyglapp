		...
		a.widget("mobile.pagecontainer", {
			...
			load: function(b, c) {
				...
				return j.reload = j.reloadPage, j.data && "get" === j.type && (l = a.mobile.path.addSearchParams(l, j.data), j.data = d), j.data && "post" === j.type && (j.reload = !0), e = this._createFileUrl(l), f = this._createDataUrl(l), k = this._find(l), 0 === k.length && a.mobile.path.isEmbeddedPage(e) && !a.mobile.path.isFirstPageUrl(e) ? (i.reject(l, j), void 0) : (this._getBase().reset(), k.length && !j.reload ? (this._enhance(k, j.role), i.resolve(l, j, k), j.prefetch || this._getBase().set(b), void 0) : (h = {
					...
					deferred: i,
					options: j
				}, g = this._triggerWithDeprecated("beforeload", h), g.deprecatedEvent.isDefaultPrevented() || g.event.isDefaultPrevented() ? void 0 : (j.showLoadMsg && this._showLoading(j.loadMsgDelay), j.prefetch === d && this._getBase().reset(), a.mobile.allowCrossDomainPages || a.mobile.path.isSameDomain(a.mobile.path.documentUrl, l) ? (a.ajax({
					url: e,
					type: j.type,
					data: j.data,
		...
		a.widget("mobile.textinput", a.mobile.textinput, {
			...
			_updateHeight: function() {
				...
				var a, b, c, d = this.element[0].scrollHeight,
					...
					h = f + g,
					i = d + h + 15;
				0 === e && (a = parseFloat(this.element.css("padding-top")), b = parseFloat(this.element.css("padding-bottom")), c = a + b, i += c), this.element.css({
					height: i,
					"min-height": "",
					"max-height": ""
				})
	...
	function(a, b) {
		...
		a.widget("mobile.popup", a.mobile.popup, {
			...
			_placementCoords: function(b) {
				var c, e, g, h, i, j, k, l = this.options.arrow,
					m = this._ui.arrow;
				return m ? (m.arEls.show(), k = {}, c = this._getPlacementState(!0), g = {
					l: {
						fst: "x",
						snd: "y",
						prop: "top",
				...
				}, h = m.bg.removeAttr("style").css("cx" === g[e.dir].dimKey ? "width" : "height", c.contentBox[g[e.dir].dimKey]).offset(), j = {
					dx: k.x.left - h.left,
					dy: k.y.top - h.top
				}, m.bg.css({
					left: f * j.dy + f * j.dx,
